      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp delay={0.1}>
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="text-xl sm:text-2xl lg:text-[20px] font-medium tracking-widest text-white uppercase opacity-90">Get a Free Quote</h2>
            <p className="mt-3 sm:mt-4 text-sm lg:text-[14px] text-slate-400 px-4 sm:px-0 leading-loose opacity-80 font-light">
              Have a project in mind? Reach out and let&apos;s discuss how I can build a high-converting website for your business.
            </p>
          </div>
        </FadeUp>
                ...
                <div>
                  ...
                  <address className="space-y-4 sm:space-y-5 not-italic">
                    <div className="flex items-center text-slate-300 text-xs sm:text-sm">
                      <Mail className="w-4 h-4 sm:w-5 sm:h-5 mr-3 text-white" aria-hidden="true" />
                      <a href="mailto:jeevankart.in@gmail.com" className="hover:text-white transition-colors">jeevankart.in@gmail.com</a>
                    </div>
                    <div className="flex items-center text-slate-300 text-xs sm:text-sm">
                      <Phone className="w-4 h-4 sm:w-5 sm:h-5 mr-3 text-white" aria-hidden="true" />
                      <a href="tel:+919873828153" className="hover:text-white transition-colors">+91 9873828153</a>
                    </div>
                  </address>
                </div>
                <div className="mt-6 sm:mt-8">
                  <a href="https://wa.me/919873828153?text=Hi%20Ritesh%2C%20I%20have%20a%20project%20to%20discuss" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-full bg-white text-black py-2.5 px-5 rounded-full font-semibold transition-all hover:bg-slate-200 hover:scale-105 outline-none text-xs sm:text-sm" aria-label="Message Ritesh on WhatsApp">
                    <MessageSquare className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-2" aria-hidden="true" />
                    WhatsApp Me
                  </a>
                </div>
              </div>
              ...
              <div className="p-5 sm:p-8 md:col-span-3">
                <form id="contact-form" className="space-y-4 sm:space-y-5" action={handleSubmit}>
                  ...
                  <div>
                    ...
                    <input type="text" id="name" name="name" required autoComplete="name" className="w-full px-3 py-2.5 rounded-xl border border-white/10 focus:ring-2 focus:ring-white/20 focus:border-white/30 transition-all outline-none bg-black/40 text-white placeholder-slate-600 text-xs sm:text-sm" placeholder="John Doe" />
                  </div>
                  <div>
                    ...
                    <input type="email" id="email" name="email" required autoComplete="email" className="w-full px-3 py-2.5 rounded-xl border border-white/10 focus:ring-2 focus:ring-white/20 focus:border-white/30 transition-all outline-none bg-black/40 text-white placeholder-slate-600 text-xs sm:text-sm" placeholder="john@example.com" />
                  </div>
                  <div>
