...
const ProfileCardComponent = ({
  ...
  // Detect mobile to disable all interactions (card becomes purely visual)
  ...
  return (
    <div
      ref={wrapRef}
      className={`relative ${isMobile ? 'touch-auto pointer-events-none' : 'touch-none'} ${className}`.trim()}
        ...
        >
          ...
          >
            ...
            >
              ...
              {showUserInfo && (
                <div
                  className="absolute flex items-center justify-between backdrop-blur-[30px] border border-white/10 pointer-events-auto"
                  style={{
                    zIndex: 10,
                    '--ui-inset': '20px',
                    '--ui-radius-bias': '6px',
            ...
            {/* Shine layer (Middle Layer) */}
            <div style={shineStyle} />

            {/* Glare layer (Top Layer) */}
            <div style={glareStyle} />

            {/* Details content (Topmost Layer for text clarity) */}
            <div
